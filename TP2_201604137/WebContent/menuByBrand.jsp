...
<body>
	...
	<div id="brandDiv">
		<select id="searchBrand" name="searchBrand" onchange="brandSearch()" style="width: 200px;height: 40px;">
			<option value="">선 택</option>
			<option value="ediya">Ediya</option>
			<option value="angel">Angel-in-us</option>
			<option value="hollys">Hollys</option>
			<option value="tomntoms">Tom n toms</option>
			<option value="twosome">Twosome Place</option>
