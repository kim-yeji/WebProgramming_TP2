...
<body>
	<div id="typeDiv">
		<select id="searchType" name="searchType" onchange="typeSearch()" style="width: 170px;height: 40px;">
			<option value="">선 택</option>
			<option value="coffee">Coffee</option>
			<option value="milk">With Milk</option>
			<option value="ade">Ade</option>
			<option value="frappu">Frappuccino</option>
	...
	<div id="all">
		<div class="ediya beverage food coffee" price="2500" menu="아메리카노" imgs="ediya/ice.JPG" >
		...
		<div class="ediya beverage food milk" price="3200"  menu="카푸치노" imgs="ediya/cappu.JPG">
		...
		<div class="ediya beverage food milk" price="3500" menu="캬라멜마끼야또" imgs="ediya/caramel1.JPG">
			<img src="<%=request.getContextPath()%>/images/ediya/caramel1.JPG"
				alt="카라멜" height="170" width="170"><br> <span>캬라멜
				마끼야또</span>
			<p>3500원</p>
			<button id="buyBtn" onclick="buyPopUp(this)">구매</button>
		</div>

		<div class="ediya beverage food etc" price="3200" menu="초콜릿" imgs="ediya/choco.JPG">
		...
		<div class="ediya beverage food smoothie" price="3800" menu="청포도스무디" imgs="ediya/grape1.JPG" >
		...
		<div class="ediya beverage food milk" price="3200" menu="녹차라떼" imgs="ediya/green1.JPG">
		...
		<div class="ediya beverage food smoothie" price="3200" menu="자두스무디" imgs="ediya/jadu1.JPG">
		...
		<div class="ediya beverage food milk" price="3500" menu="카페모카" imgs="ediya/mocha1.JPG">
		...
		<div class="angel beverage food smoothie"  price="5600" menu="딸기스노우" imgs="angel/berry.JPG" >
		...
		<div class="angel beverage food milk" price="5000"  menu="카푸치노" imgs="angel/cappu.JPG">>
		...
		<div class="angel beverage food milk" price="5000"menu="카라멜마끼야또" imgs="angel/caramel.JPG" >
		...
		<div class="angel beverage food smoothie" price="6000" menu="그린티스노우" imgs="angel/green.JPG">
		...
		<div class="angel beverage food coffee" price="3900" menu="아메리카노" imgs="angel/hot.JPG">
		...
		<div class="angel beverage food smoothie" price="5600" menu="망고스노우" imgs="angel/mango.JPG" >
		...
		<div class="angel beverage food milk" price="5100" menu="카페모카" imgs="angel/mocha.JPG">
		...
		<div class="angel beverage food etc" price="6300"menu="핑크초코블라썸" imgs="angel/pink.JPG" >
		...
		<div class="hollys beverage food milk"price="4600"menu="카푸치노" imgs="hollys/cappu.JPG">
		...
		<div class="hollys beverage food etc"price="5900"menu="벨지안초코" imgs="hollys/choco.JPG">
		...
		<div class="hollys beverage food ade" price="5500"menu="청포도스파클링" imgs="hollys/grape.JPG">
		...
		<div class="hollys beverage food coffee" price="4100" menu="아메리카노" imgs="hollys/hot.JPG">
		...
		<div class="hollys beverage food ade" price="5500"menu="자몽스파클링" imgs="hollys/jamong.JPG">
		...
		<div class="hollys beverage food tea" price="4300"menu="할리스유자차" imgs="hollys/jeju.JPG">
		...
		<div class="hollys beverage food milk" price="4600"menu="카페라떼" imgs="hollys/latte.JPG">
		...
		<div class="hollys beverage food etc" price="5300" menu="민트초코" imgs="hollys/mint.JPG">
		...
		<div class="hollys beverage food milk" price="5500"  menu="카페모카" imgs="hollys/mocha.JPG">
		...
		<div class="hollys beverage food etc" price="5200"menu="화이트초코" imgs="hollys/whitechoco.JPG">
			<img
		...
		<div class="tomntoms beverage food milk" price="4300"menu="카푸치노" imgs="tomntoms/cappu.JPG">
		...
		<div class="tomntoms beverage food milk" price="4800" menu="카라멜마끼야또" imgs="tomntoms/caramel.JPG">
			<img
		...
		<div class="tomntoms beverage food frappu" price="5300" menu="자바칩탐앤치노" imgs="tomntoms/choco.JPG">
		...
		<div class="tomntoms beverage food smoothie" price="4100" menu="청포도스무디" imgs="omntoms/grape.JPG">
		...
		<div class="tomntoms beverage food frappu" price="4900" menu="그린티탐앤치노" imgs="tomntoms/green.JPG">
		...
		<div class="tomntoms beverage food coffee" price="3800"  menu="아메리카노" imgs="tomntoms/hot.JPG">
		...
		<div class="tomntoms beverage food ade" price="4800" menu="자몽에이드" imgs="tomntoms/jamong.JPG">
		...
		<div class="tomntoms beverage food smoothie" price="4900" menu="키위스무디" imgs="tomntoms/kiwi.JPG">
		...
		<div class="tomntoms beverage food milk" price="4200" menu="카페라떼" imgs="tomntoms/latte.JPG">
		...
		<div class="tomntoms beverage food smoothie" price="5500" menu="타로스무디" imgs="tomntoms/taro.JPG">
			...
			<div class="twosome beverage food coffee" price="4100" menu="아메리카노" imgs="twosome/ice.jpg">
		...
		<div class="twosome beverage food ade" price="5500" menu="오렌지에이드" imgs="twosome/ade.JPG">
		...
		<div class="twosome beverage food etc" price="5800" menu="딸기복숭아프라페" imgs="twosome/berry.JPG">
		...
		<div class="twosome beverage food milk" price="4600"  menu="카푸치노" imgs="twosome/cappu.JPG">
		...
		<div class="twosome beverage food tea" price="5500"  menu="로얄밀크티" imgs="twosome/tea.JPG">
